...
class BaseCommand:
    ...
    output_transaction = False  # Whether to wrap the output in a "BEGIN;
    # COMMIT;"
    ...
    def execute(self, *args, **options):
        ...
        if options["force_color"] and options["no_color"]:
            raise CommandError(
                "The --no-color and --force-color "
                "options can't be used together."
            )
